...
dependencies, install symantecssl in ``editable`` mode. For example:
...
symantecssl unit tests are found in the ``tests/`` directory and are
...
symantecssl documentation is stored in the ``docs/`` directory. It is
